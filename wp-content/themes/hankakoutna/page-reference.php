...
<div id="main">
    ...
    <div class="panel red testimonials">
        ...
        <div class="panel inner clearfix">
            <div class="scroller" data-for="testimonials-switch">
                <div class="screen clearfix">
                    <div class="view">
                        <p class="text">„Znám jen velmi málo opravdu dobrých moderátorů, proto obdivuji Hanku Koutnou. Její moderování je živelné, informované, má "šťávu" a vtip a navíc působí empaticky a laskavě. A to je vzácný dar.“</p>
        ...
        <ul class="switch" id="testimonials-switch">
        </ul>
    </div>
